  ...
  <script type="text/javascript">
	...
	function setImageURL2(url) {
	    ...
	    function uploadFileFun(){
	      ...
	      fd.append("materialPersonal",fileObj1); // 传给后台的参数 “file” 参数名 fileObj 文件对象
	      fd.append("materialMortgage",fileobj2);
	      /**
	      ...
	      **/
	      ...
	      xhr.open("POST", "/loan/loan/addPersonalLoan"); // 给后台提交的路径
	      xhr.send(fd);
	    }
    ...
    function uploadComplete(evt){
      ...
      if(message.isSuccess){ // 后台返回的code值
        layer.alert("个人贷款申请已创建，请静候管理员审批");
        var timer1=window.setTimeout(function(){
		 	 window.location.href="/loan/index/toLoanRecord";
		 },3000); 
      }else{
        alert("上传失败！");
      }
