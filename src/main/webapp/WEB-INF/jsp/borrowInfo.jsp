		  			...
		  			<form id="myForm" class="form-horizontal">
		  				<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge " id="loanName" type="text" name="loanName" value="${user.userInfo.userRealname }" required="required" >
								</div>
							</div>
							  
							  <div class="control-group">
								<label class="control-label" for="loanPhone">手机号码：</label>
								<div class="controls">
								  <input class="input-xlarge " id="loanPhone" type="text" name="loanPhone" value="${user.userInfo.userPhone }" required="required">
								</div>
							  </div>
							  
							  <div class="control-group">
								<label class="control-label" for="loanLocation">联系地址：</label>
								<div class="controls">
								  <input class="input-xlarge " id="loanLocation" type="text" name="loanLocation" value="" required="required" />
								</div>
							  </div>
  		...
  		var option={
			...
			success:function(data){
				...
				if(data.isSuccess){
					...
					$.ajax({
						type:"post",
						url:"index/toPersonalLoanMaterial",
						async:true,
						success:function(result){
						    $("#detailArea").html(result);
						     $(".modal-footer").html("<a href='javascript:uploadFileFun()' class='btn btn-success'>上传</a>");
